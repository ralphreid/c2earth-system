...
describe PhasesController do
  ...
  let(:valid_attributes) { { "phase" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved phase as @phase" do
        ...
        post :create, {:phase => { "phase" => "invalid value" }}, valid_session
        assigns(:phase).should be_a_new(Phase)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested phase" do
        ...
        Phase.any_instance.should_receive(:update).with({ "phase" => "MyString" })
        put :update, {:id => phase.to_param, :phase => { "phase" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the phase as @phase" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Phase.any_instance.stub(:save).and_return(false)
        put :update, {:id => phase.to_param, :phase => { "phase" => "invalid value" }}, valid_session
        assigns(:phase).should eq(phase)
      end
